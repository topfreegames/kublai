...
const KhanService = function (khanUrl, timeout, app, component) {
...
module.exports = function (khanUrl, timeout, app, component) {
  return new KhanService(khanUrl, timeout, app, component)
}
