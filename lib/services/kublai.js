...
KhanService.prototype.searchClans = function (gameId, term, callback) {
  ...
  if (!term) {
    callback('No search term was provided.', null)
    return
  }
...
KhanService.prototype.approveDenyMembershipApplication = function (
  ...
  if (!action) {
    callback('No action was provided.', null)
    return
  }
...
KhanService.prototype.createHook = function (
  ...
  if (!hookType) {
    callback('No hook type was provided.', null)
    return
  }
  if (!hookURL) {
    callback('No hook URL was provided.', null)
    return
  }
...
KhanService.prototype.removeHook = function (
  ...
  if (!hookPublicId) {
    callback('No hook public id was provided.', null)
    return
  }
