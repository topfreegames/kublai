...
KhanService.prototype.createGame = function (
  ...
  } else if (typeof options === 'object' && options.maxPendingInvites) {
    payload.maxPendingInvites = options.maxPendingInvites
  }
...
KhanService.prototype.updateGame = function (
  ...
  if (typeof options === 'object' && options.maxPendingInvites) {
    payload.maxPendingInvites = options.maxPendingInvites
  }
